...
#######################################################################################################
#ATENCIÓN! para que el script pueda ejecutarse, han debido instalarse los siguientes módulos:
...
#ATENCIÓN! si éstos módulos no están instalados previamente a la ejecució del script
#
#Se ha preparado 'DSC-0-InstalaModulos.ps1' para instalarlos. 
#######################################################################################################
...
Configuration ConfiguraPrimerDC{
    ...
    Node $ComputerName{
        ...
        ##Ojo plain text:  #https://dille.name/blog/2014/12/12/handling-plain-text-credentials-in-powershell-dsc/
